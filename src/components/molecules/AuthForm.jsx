    ...
    >
      {isRegister && (
        <DivContainerCenter>
          ...
          />
          {errors.name ? (
            <span className="flex items-center justify-end w-full gap-1 text-rose-400 text-xs font-light mt-1">
              {errors.name.message}
            </span>
          ) : (
            <span className="text-transparent pointer-events-none w-full text-xs font-light mt-1">
              ghost
            </span>
          )}
        </DivContainerCenter>
